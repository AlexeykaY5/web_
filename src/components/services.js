    ...
    return (
      <section className='services'>
        ...
        <div className='services_blocks'>
          <div className='block'>
            <img src={drilling} alt="drilling" style={{ width: "100px" }}/>
          ...
          <div className='block'>
            <img src={brickwall} alt="brickwall" style={{ width: "100px" }}/>
